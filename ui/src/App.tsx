...
function threadStatusTransitions(items: ThreadItem[]) {
  const transitions = new Map<string, { from: ThreadWorkflowStatus | null; to: ThreadWorkflowStatus }>();
              ...
              (() => {
                ...
                return (
                  <div
                    ...
                    ref={expanded ? expandedOutputRef : undefined}
                  >
                    <button
                      type="button"
      ...
      if ((result as { fixture?: boolean } | null)?.fixture) {
        ...
        setTasks((current) =>
          current.map((entry) => {
            ...
            if (args[0] === 'interrupt') return { ...entry, state: 'CANCELLED' as TaskState, attention: null };
            if (args[0] === 'approve')
                ...
                <div className="header-actions">
                  ...
                  {!taskDone && (
                    <button
                      ...
                      onClick={() => void act(['interrupt', task.id], 'Task cancellation requested')}
                    >
