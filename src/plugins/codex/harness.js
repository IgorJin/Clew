...
/** Codex app-server protocol implementation (moved verbatim from
 * `src/harness.js` in CLEW-128). The domain only receives normalized events;
 * consumers resolve this module through the plugin registry, never by
 * importing harness internals. `src/harness.js` re-exports `CodexHarness`
 * and `codexLaunchError` as a compatibility facade until CLEW-133. */
