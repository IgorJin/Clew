...
- CLI task lifecycle, plan inspection/approval, JSON output, status, events, and diagnostics.

The remaining v0.1 candidate work is tracked in [`tasks.md`](./tasks.md) and gated in [`RELEASE.md`](./RELEASE.md), including live validation and conformance for Codex/OpenCode adapters, harness approval/interrupt handling, human-assisted conflict resolution, and hardening.
