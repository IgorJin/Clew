...
`status` and `updated` are updated whenever work changes state. `owner` may remain `null` until someone takes the task. A task becomes `done` only when all acceptance criteria and verification listed in its card pass.
...
| [CLEW-068](./CLEW-068.md) | v0.4    | planned | 067        | —                  |
| [CLEW-069](./CLEW-069.md) | v0.4    | planned | 068        | v0.4-control-plane |
| [CLEW-070](./CLEW-070.md) | v0.4    | planned | 068        | v0.4-control-plane |
| [CLEW-071](./CLEW-071.md) | v0.4    | planned | 068        | v0.4-control-plane |
| [CLEW-072](./CLEW-072.md) | v0.4    | planned | 068        | v0.4-control-plane |
| [CLEW-073](./CLEW-073.md) | v0.4    | planned | 068        | v0.4-control-plane |
...
5. Before `done`, execute the task's verification section and record the resulting commit or release evidence under **Completion record**.
